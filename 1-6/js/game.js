...
const fireballSound = document.getElementById('fireballSound');// 火の玉サウンド
...
class BossEnemy extends Enemy {
    constructor(x, y, width, height, speed, minX, maxX) {
        ...
        this.maxMinionSpawnCooldown = 5000; // 5秒ごとに召喚

        // 火の玉攻撃関連 (新規追加)
        this.fireballCooldown = 0;
        this.maxFireballCooldown = 2660; // 3秒ごとに発射
    }
    ...
    shootFireball(player) {
        ...
        playSound(fireballSound); // <<< fireballの音声
    }
}
...
function stageClear() {
    ...
    if (currentStage < MAX_STAGES) {
        ...
        nextStageButton.onclick = () => {
            window.location.href = '../1-7/index.html';
        };
    }
}
